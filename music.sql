...
(
  id_song INTEGER REFERENCES songs (id) ON DELETE CASCADE,
  id_artist INTEGER REFERENCES artists (id) ON DELETE CASCADE,
...
(
  id_song INTEGER REFERENCES songs (id) ON DELETE CASCADE,
  id_producer INTEGER REFERENCES producers (id) ON DELETE CASCADE,
  PRIMARY KEY (id_song, id_producer)
);
...
INSERT INTO song_producers VALUES
  (1, 1),
  (1, 2),
  (2, 3),
  (3, 4),
